...
CFTRender CGraphicsDriverEGL::mRender(10000);
...
void CGraphicsDriverEGL::run()
{
	while (true)
	{
		...
		usleep(200000); // TODO hack hardcoded update rate to prevent busy loop;
	}
}

void CGraphicsDriverEGL::renderText(float posX, float posY, float scale,
		const char* text)
{
