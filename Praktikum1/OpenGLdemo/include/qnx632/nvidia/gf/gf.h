...
typedef enum {
	...
	GF_FORMAT_BGRA8888 = 32 | GF_FORMAT_ALPHA | GF_FORMAT_RGB,
...
extern int gf_display_set_external_chroma(gf_display_t display,
    gf_chroma_t *chroma);
extern int gf_display_set_color_lut(gf_display_t display, const uint16_t *redLUT, 
...
#define GF_CONTEXT_PATTERN_8X1			0x80000000
