...
void rasSetScissor(rasterizer *ras, scissorEdge *edges, unsigned int size);							
void rasAddEdge(strokedPoly *poly, gf_fxpt_t *v0, gf_fxpt_t *v1);
void rasFill(strokedPoly *poly, int vpx, int vpy, int vpwidth, int vpheight, int fillRule);
