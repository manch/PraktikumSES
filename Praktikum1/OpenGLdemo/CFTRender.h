...
public:
	...
	enum {FONT_SIZE_DEFAULT = 20, FONT_SIZE_MINI = 12, FONT_SIZE_MEDIUM = 20, FONT_SIZE_MAXIMUM = 40 };
	...
	/**
	 * \brief sets the fontsize
	 *
	 * predefined sizes are
...
protected:
	...
	//TODO to store the index of the unicode charmap for the font with the current fontid.
